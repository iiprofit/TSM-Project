...
> {
          ...
          >
            <Layout.Content style={{ marginTop: "3em" }}>
              <Row>
                ...
                <Col span={12}>
                  <Form.Item label="Select Status Type">
                    <Select
                      ...
                      onChange={(value) =>
                        this.setState({ srchStatusTypeSelected: value })
                      }
                    >
                      {srchStatusType &&
                ...
                <Col span={12}>
                  <Form.Item label="Select Priority">
                    <Select
                      ...
                      optionFilterProp="children"
                      onChange={(value) =>
                        this.setState({ srchPrioritySelected: value })
                      }
                    >
                      {srchPriority &&
                ...
                <Col span={12}>
                  <Form.Item label="Select Assigned To">
                    <Select
                      ...
                      optionFilterProp="children"
                      onChange={(value) =>
                        this.setState({ srchAssignedToSelected: value })
                      }
                    >
                      {srchAssignedTo &&
                ...
                <Col span={12}>
                  <Form.Item label="Select Customer">
                    <Select
                      ...
                      onChange={(value) => {
                        console.log(value);
                        this.setState({ srchCustomerSelected: value });
                      }}
                    >
                      {srchCustomer &&
                ...
                <Col span={8}>
                  <Form.Item>
                    <Button type="primary" onClick={this.fetchSearchResult}>
                      Search
                    </Button>
                  </Form.Item>
                </Col>
                ...
                <Col span={8}>
                  <Form.Item>
                    <Button type="primary" onClick={this.resetAll}>
                      Reset
                    </Button>
                  </Form.Item>
                </Col>
                ...
                <Col span={8}>
                  <Form.Item>
                    <Button type="primary" onClick={this.downloadSearchResult}>
                      Download Result
                    </Button>
                  </Form.Item>
                </Col>
  ...
  resetAll = () => {
    try {
      this.setState({ srchStatusTypeSelected: null, srchCustomerSelected: [] });
    } catch (error) {
      console.error(error);
    }
  };
  ...
  private customSearch = () => {
    try {
      ...
      let tempstartdate = dayjs(startDate).format("YYYY-MM-DD").toString();
      let tempenddate = dayjs(endDate).format("YYYY-MM-DD").toString();
  ...
  downloadSearchResult = async () => {
    try {
      ...
      let columns = [
        ...
        { header: "Ticket Status", key: "TransactionStatus", width: 26 },
      ];
